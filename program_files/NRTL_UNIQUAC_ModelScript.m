...
sheet_name = "Glyc-Rofe_T"; % Modify this line for data selection
...
% H20(7) , CH3(1) , CH(1), OH(5), ACH (10) , AC (11) , ACOH (18), ACNH2 (37) , COOH (42)

Rg = [0.9200 , 0.9011, 0.4469, 1   , 0.5313 , 0.3652 , 0.8952 , 1.060 , 1.3013 ];
Qg = [1.4    ,  0.848, 0.228 , 1.2 , 0.4    , 0.120  , 0.680  , 0.816 , 1.224 ];
...
Hfus = 39650; % Heat of Fusion [kJ / mol]
Tfus = 521;% Temp. of fusion [K]
...
%JAVHF_CvalsT = JA_VHF_corr_fun(sys_sol_data,sys_T+273.15);
...
%These are arbitary optimisation optins I picked from fiddling with
%mesalazine


%TOR = fmincon(@objfun,x0,A,b,Aeq,beq,lb,ub,@mycon,opts);
%}
%set-up optimisation problem:
